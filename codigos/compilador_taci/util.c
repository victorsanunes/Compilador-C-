...
{ switch (token)
  { case IF:
    ...
    case OPENCOL: fprintf(listing,"[\n"); break;
    case CLOSECOL: fprintf(listing,"]\n"); break;
    case OPENKEY: fprintf(listing,"{\n"); break;
    case CLOSEKEY: fprintf(listing,"}\n"); break;
...
TreeNode * newDeclNode(DeclKiind kind)
{
    TreeNode * t = (TreeNode *) malloc(sizeof(TreeNode));
    int i;
    if (t==NULL)
